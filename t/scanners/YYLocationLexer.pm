...
package YYLocationLexer;

#line 13 "Parse/Kalex/Snippets/Base.pm"
...
#line 415 "t/scanners/YYLocationLexer.pm"
sub __yyinit {
    my ($self) = @_;

    $self->{__rules} = [
        [[],'.|\\n',0,[],['t/scanners/YYLocationLexer.l',4,2]],
        [['-1'],'.|\\n',0,[],['/Users/guido/perl/Parse-Kayak/lib/Parse/Kalex/Generator.pm',345,8]],
    ];
    # FIXME! yyprefix all of them!
    $self->{__condition_types} = ['s'];
    $self->{__yycondition_names} = {'INITIAL' => 0};
    $self->{__yyconditions} = ['INITIAL'];
    $self->{__yyoptions} = {'yylineno' => 1,'package' => 'YYLocationLexer'};

    $self->__yyinitMatcher;
}
#line 431 "t/scanners/YYLocationLexer.pm"
sub yylex {
    my ($self) = @_;
...
#line 4 "t/scanners/YYLocationLexer.l"
YYRULE0: 
        ; next;

#line 345 "/Users/guido/perl/Parse-Kayak/lib/Parse/Kalex/Generator.pm"
YYRULE1: $self->ECHO;
        ; next;
...
#line 5 "t/scanners/YYLocationLexer.l"
$self->{yyin} = 't/scanners/YYLocationLexer.in';
